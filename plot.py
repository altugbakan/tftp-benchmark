...
df = df[(df["transfer_type"] == "get") & (df["block_size_bytes"] == 8192)]

# Loop over each unique "name" and create a scatter plot
...
plt.title(
    "Comparison of Get Transfer Time by Name and File Size with Block Size = 1024"
)
plt.legend()
plt.show()
